...
<div class="row row-overflow">
	...
	<div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
		...
		<div class="eqLogicThumbnailContainer">
			<div class="cursor eqLogicAction" data-action="add" style="background-color : #ffffff; height : 140px;margin-bottom : 10px;padding : 5px;border-radius: 2px;width : 160px;margin-left : 10px;" >
				<center>
					<i class="fa fa-plus-circle" style="font-size : 5em;color:#767676;"></i>
				</center>
				<span style="font-size : 1.1em;position:relative; top : 23px;word-break: break-all;white-space: pre-wrap;word-wrap: break-word;color:#767676"><center>{{Ajouter}}</center></span>
			</div>
   ...
   <div class="col-md-10 eqLogic" style="border-left: solid 1px #EEE; padding-left: 25px;display: none;">
        ...
        <form class="form-horizontal">
            <fieldset>			
                ...
                <div class="form-group wizard">
                    <label class="col-md-2 control-label">{{Nom de l'équipement KNX}}</label>
                    <div class="col-md-3 data-info" style="display : none;">
                        <p>Indiquez le nom de votre équipement</p>
                    </div>
                    <div class="col-md-3">
                ...
                <div class="form-group wizard expertModeVisible">
                    <label class="col-md-2 control-label ">{{Adresse Physique de l'équipement}}</label>
                    <div class="col-md-3 data-info" style="display : none;">
                        <p>Indiquez l'adresse physique de votre équipement</p>
                        <p>Cette information n'est pas obigatoire mais peut etre utile dans certain cas</p>
                        <p>Pour la trouver, il faut la retrouver sur le logiciel ETS</p>
                    </div>
                    <div class="col-lg-3">
                ...
                <div class="form-group wizard">
                    ...
                    <div class="col-md-3 data-info" style="display : none;">
                        <p>Indiquez l'objet dans lequel le widget de cette equipement apparaiterai sur le dashboard</p>
                    </div>
                    <div class="col-md-3">
                ...
                <div class="form-group wizard">
                    ...
                    <div class="col-md-3 data-info" style="display : none;">
                        ...
                        <p>Cette information n'est pas obigatoire mais peut etre utile pour filtrer les widget</p>
                    </div>
                    <div class="col-md-8">
                        <?php
				...
				<div class="form-group wizard">
					<label class="col-sm-2 control-label" >Etat du widget</label>
					<div class="col-md-3 data-info" style="display : none;">
						<p>Choisissez les options de visibilité et d'activation</p>
						<p>Si l'equipement n'est pas activé il ne sera pas ustilisable dans jeedom, mais visible sur le dashboard</p>
						<p>Si l'equipement n'est pas visible il ne sera caché sur le dashbord, mais utilisable dans jeedom</p>
					</div>
					<div class="col-sm-9">
				...
				<div class="form-group expertModeVisible wizard">
                    ...
                    <div class="col-md-3 data-info" style="display : none;">
                        <p>Cette inforamtion est obtionnelle et permet de définir si un équipement est fonctionnelle ou non</p>
                        <p>Il ne peut etre utilisé que si votre équipement envoi régulierement des information (sonde de température, horloge, ...)</p>
                    </div>
					<div class="col-md-3">
        ...
        <a class="btn btn-success btn-sm cmdAction" data-action="add"><i class="fa fa-plus-circle"></i> {{Ajouter une commande KNX}}</a><br/><br/>
