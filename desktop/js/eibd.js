  ...
  if (!isset(_cmd)) {
	...
	tr.append($('<td class="wizard">')
		.append($('<div>')
			.append($('<span>')
				.append($('<label class="checkbox-inline">')
					.append($('<input type="checkbox" class="cmdAttr checkbox-inline" data-size="mini" data-label-text="{{Inverser}}" data-l1key="configuration" data-l2key="inverse" checked/>'))
					.append('{{Inverser}}')
					.append($('<sup>')
						.append($('<i class="fa fa-question-circle tooltips" style="font-size : 1em;color:grey;">')
	...
	alert(init(_cmd.configuration.KnxObjectType));
	tr.append($('<td class="wizard">')	
	...
	parmetre.append($('<a class="btn btn-default btn-xs cmdAction expertModeVisible bt_read">').hide()
		...
		parmetre.append($('<div>')
			.append($('<span>')
				.append($('<label class="checkbox-inline">')
					.append($('<input type="checkbox" class="cmdAttr checkbox-inline" data-size="mini" data-label-text="{{Niveau Batterie}}" data-l1key="configuration" data-l2key="noBatterieCheck" checked/>'))
	...
	$('#table_cmd tbody tr:last').find('.cmdAttr[data-l1key=configuration][data-l2key=KnxObjectValue] option[value="'+init(_cmd.configuration.KnxObjectValue)+'"]')		
