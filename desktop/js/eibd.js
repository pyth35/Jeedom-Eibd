	...
	tr.append($('<td class="wizard" CmdParametter>')
		.append($('<div class="ObjetTransmit">')
                		...
                		.append($('<div class="input-group">')
							...
							.append($('<input cmdAttr form-control input-sm expressionAttr" data-l1key="configuration" data-l2key="ObjetTransmit">'))
							.append($('<span class="input-group-btn">')
		...
		.append($('<span class="RetourEtat">')
						...
						.append($('<div class="input-group">')
							...
							.append($('<input cmdAttr form-control input-sm expressionAttr cmdAction" data-l1key="value">'))
							.append($('<span class="input-group-btn">')
