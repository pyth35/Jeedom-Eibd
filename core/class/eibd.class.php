...
class eibd extends eqLogic {
	...
	public static function deamon_start($_debug = false) {
		...
		if(file_exists('/etc/eibd/knxd_VERSION'))
			...
			$cmd = 'sudo knxd knxd -u /tmp/eib -u /var/run/knx --daemon=/var/log/knx.log --pid-file=/var/run/knx.pid --eibaddr='.config::byKey('EibdGad', 'eibd').' --listen-tcp='.config::byKey('EibdPort', 'eibd').' -b';
		else
