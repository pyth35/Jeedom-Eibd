...
class eibd extends eqLogic {
	...
	public static function deamon_start($_debug = false) {
		...
		if(file_exists('/etc/eibd/knxd_VERSION'))
			...
			$cmd = 'sudo knxd --daemon=/var/log/knx.log --pid-file=/var/run/knx.pid --eibaddr='.config::byKey('EibdGad', 'eibd').' -D -S -T -R --Name="Jeedom_KNX" --listen-tcp='.config::byKey('EibdPort', 'eibd');
		else
